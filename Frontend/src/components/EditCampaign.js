  ...
  useEffect(() => {
    const loadCampaign = async () => {
      try {
        ...
        const response = await axios.get(`https://zitharaproject.onrender.com/api/campaigns/${id}`, {
          headers: {
            'x-auth-token': token
          }
        });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (formData.image) {
        ...
        await axios.put(`https://zitharaproject.onrender.com/api/campaigns/${id}`, formDataToSend, {
          headers: {
            'x-auth-token': token
          }
        });
      } else {
        await axios.put(`https://zitharaproject.onrender.com/api/campaigns/${id}`, requestData, {
          headers: {
            'x-auth-token': token,
